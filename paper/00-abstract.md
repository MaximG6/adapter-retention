...
model's stored integer codes unchanged**, and — across **six rank-32 adapters sharing one
base model and one training recipe** — leaves
**no detectable change in their trained behaviour**: elicitation retention is 99.2%, with an exact 95% interval of
